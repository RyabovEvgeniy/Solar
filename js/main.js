$(function(){
	...
	// tabs
	$('.tarif-tabs__item').on('click', function (e) {
		e.preventDefault();

		$('.tarif-tabs__item').removeClass('tarif-tabs__item_active');
		$(this).addClass('tarif-tabs__item_active');

		$('.tarif-tabs__content').removeClass('tarif-tabs__content_active');
		$($(this).attr('href')).addClass('tarif-tabs__content_active');
	});

	// slider
	$('.tarif-slider, .clients-slider').slick({
		fade: true,
